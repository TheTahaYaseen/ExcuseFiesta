...
urlpatterns = [
    path("", views.excuses_view, name="excuses"),
    path("<str:primary_key>/", views.excuse_view, name="excuse"),

    path("categories", views.excuse_categories_view, name="excuse_categories"),
    path("categories/<str:primary_key>", views.excuse_category_view, name="excuse_category"),
